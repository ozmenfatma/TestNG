...
public class Day20_C02_SoftAssertion {
    ...
    @Test
    public void softAssertTest() {  // test hata verse bile calismayi durdurmaz.
        ...
        softAssert.assertAll();//PASS yada FAIL olarak assertion lari isaretler. kendisine kadar olan kismi raporlar.hangisi fail hangisi pass
    }
