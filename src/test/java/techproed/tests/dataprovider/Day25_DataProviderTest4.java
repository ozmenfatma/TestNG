...
//bu ornekte data provider methodu Util classdan geelcektr


    @Test (dataProvider = "musteriVerileri" , dataProviderClass = DataProviderUtils.class)// farkli sinifta oldugu icin utilities  bu sekilde birbirine bagliyoruz  dataProviderClass = DataProviderUtils.class  --> .class bunun class oldugunu belirtmek icin
