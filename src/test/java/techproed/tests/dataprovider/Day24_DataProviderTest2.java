...
public class Day24_DataProviderTest2 {
    ...
    public Object[][] customerData(){
        Object [][] musteriBilgileri={
                {"sam.walker@bluerentalcars.com", "tc!fas_art"},
    ...
    public void dataProviderTest(String email, String password) {// 2 parametreyide kullanmak zorunda degilim. ihtiyacim olursa alirim
