...
public class Day22_SmokeTestBilgi {
    ...
    //en onemli fonks test edildigi login checkin checkout add to cart make payment sign out  gibi ozellikler. Smoke Test
/*
    SMOKE TEST
...
18 tane
    ...
    */
    ...
    //Regression Test : önceki testlerde belirlenen sorunların giderildiğinden ve yeni eklenen özelliklerin
    // sorunsuz çalıştığından  ve yeni hatalar oluşmadığından emin olmak icin yapilir.

    //major bug'ın düzeltilmesinden sonra ve major releasestan önce yapilir
/*
    REGRESSION TEST
