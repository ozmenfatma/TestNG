...
public class ExcelUtils {
    ...
    public ExcelUtils(String path, String sheetName) {//This Constructor is to open and access the excel file
        ...
        try {
            ...
            // data doluysa worksheet cek yoksa message ver
...
//    Exceldeki verileri Test sinifinda kullanmak icin bu metotu kullanacaz
    ...
    //Exceldeki satir sayisini returm eder
    public int rowCount() {
    ...
    //Excel deki dataalaru=i iki boyutlu array seklinde aliyoruz
    ...
    //Deger,satir,sutun girildiginde 0 satir ve sutuna girilen veriyi ekler
    ...
    //bu method ustteki method un yardimcisi. birlikte calisiri. overload eder. parametreleri farkli
